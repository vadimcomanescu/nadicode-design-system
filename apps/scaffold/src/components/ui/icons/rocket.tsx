...
const VARIANTS: Variants = {
  ...
  animate: {
    x: [0, 0, -3, 2, -2, 1, -1, 0],
    y: [0, -3, 0, -2, -3, -1, -2, 0],
    transition: { duration: 6, ease: "easeInOut", repeat: Infinity, repeatType: "reverse" as const, times: [0, 0.15, 0.3, 0.45, 0.6, 0.75, 0.9, 1] },
  },
};
...
const FIRE_VARIANTS: Variants = {
  ...
  animate: {
    ...
    transition: { duration: 2, ease: [0.4, 0, 0.2, 1], repeat: Infinity, times: [0, 0.3, 0.6, 1] },
  },
};
  ...
  ({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
    ...
    return (
      <div className={cn(className)} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} {...props}>
        <motion.svg animate={controls} fill="none" height={size} stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" variants={VARIANTS} viewBox="0 0 24 24" width={size} xmlns="http://www.w3.org/2000/svg">
