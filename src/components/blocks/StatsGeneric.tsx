    ...
    return (
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card variant="glass">
                ...
                <CardContent>
                    <div className="text-2xl font-bold text-text-primary">+2350</div>
                    <p className="text-xs text-text-secondary flex items-center mt-1">
                        <ArrowUpRight className="h-3 w-3 text-emerald-500 mr-1" />
            ...
            <Card variant="glass">
                ...
                <CardContent>
                    <div className="text-2xl font-bold text-text-primary">+12,234</div>
                    <p className="text-xs text-text-secondary flex items-center mt-1">
            ...
            <Card variant="glass">
                ...
                <CardContent>
                    <div className="text-2xl font-bold text-text-primary">+573</div>
                    <p className="text-xs text-text-secondary flex items-center mt-1">
                        <ArrowUpRight className="h-3 w-3 text-emerald-500 mr-1" />
