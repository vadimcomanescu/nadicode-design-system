  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            "duration-300 relative h-svh w-[--sidebar-width] bg-transparent transition-[width] ease-[cubic-bezier(0.34,1.56,0.64,1)]",
        ...
        <div
          className={cn(
            "duration-300 fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] transition-[left,right,width] ease-[cubic-bezier(0.34,1.56,0.64,1)] md:flex",
            side === "left"
